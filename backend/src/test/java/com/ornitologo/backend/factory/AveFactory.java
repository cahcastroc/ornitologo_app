...
public class AveFactory {
    ...
    private static Ave calopsita = new Ave(1L, "Calopsita", "Nympcus", "Familia Hollandicus", Instant.parse("2022-11-07T10:00:00Z")
    );
    private static Ave canario = new Ave(1L, "Canario", "Nympcus", "Familia Nymps", Instant.parse("2022-11-07T10:00:00Z")
    );
    private static Ave papagaio = new Ave(1L, "Papagaio", "Papis", "Familia Dics", Instant.parse("2022-11-07T10:00:00Z")
    );
